...
- Вражеские снаряды босса.
- Набор отдельных внешних спрайтов в `assets/textures/sprites/`.
- Внешние звуки `assets/sounds/*.wav`.
- Несколько скачанных CC0 музыкальных loop-файлов для меню, игры, босса и Game Over.
...
В текущем окружении мобильные SDK и CMake могут отсутствовать; скрипт покажет, чего не хватает.
...
1. Конвертировать WAV-музыку в OGG, чтобы уменьшить размер репозитория.
2. Добавить отдельные анимации для корабля, боссов и взрывов.
3. Расширить атаки боссов снарядами с разными траекториями.
4. Добавить очистку таблицы рекордов через меню настроек.
